    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (login_btn.equals("Login")) {
            try {
                ...
                ResultSet res = stmt.executeQuery("select * from  stud_admission");
                ...
                while (res.next()) {
                    ...
                    if (username.equals(id)) {
                        ...
                        while (ress.next()) {
                            out.println("<h3 class=\"fs-title\"><b>" + res.getString(1) + "'s Home Page</b></h3><br>\n"
                                    + "                <table>\n"
                                    + "                    <th>Date</th>\n"
                                    + "                    <th>Subject</th>\n"
                                    + "                    <th>Attendance</th>\n");
